...
const Dreambig = () => {
  ...
  return (
    <View style={styles.dreambigView}>
      <View style={styles.frameView11}>
        <View style={styles.groupView}>
          ...
          <View style={styles.frameView1}>
            <Text style={styles.dreamBigText}>Dream big!</Text>
          </View>
        </View>
        <View style={[styles.frameView10, styles.mt10]}>
          <View style={styles.frameView3}>
            ...
            <Pressable
              style={[styles.framePressable, styles.ml5]}
          ...
          <View style={[styles.frameView7, styles.mt23]}>
            <View style={styles.frameView4}>
              ...
              <Text style={[styles.buildYourDreamHouseWithVi, styles.ml13]}>
                Build your dream house with virtual reality experience using
                VSpace
              </Text>
            </View>
            <View style={[styles.frameView6, styles.mt6]}>
              <View style={styles.lineView} />
              <View style={[styles.frameView5, styles.ml7]}>
                <Text style={styles.timothyCorriganText}>Timothy Corrigan</Text>
              </View>
            </View>
          </View>
          <View style={[styles.frameView9, styles.mt23]}>
            <Pressable
